$(document).ready(function(){
    ...
    $('.rp-select').click(function(){
        if($('.gen-area').hasClass('area-disabled')) {
            sweetAlert("Error", "Please connect your account first.", "error");
        } else {
            fixRPBox($(this));
        }
    });
    ...
    $('.submit-btn').click(function(){
        sweetAlert("Error", "The code you entered is invalid or incorrect..", "error");
    });
        ...
        if($account_connected == false) {
            if($('#usernameInput').val() != '') {
                if($('#serverInput').val() != '') {
                    ...
                    sweetAlert("Error", "Please enter your platform.", "error");
                }
            } else {
    ...
    $('.gen-button').click(function(){
        if($('.gen-area').hasClass('area-disabled') || $account_connected == false) {
            ...
            if($selected_rp != ''){
                ...
                sweetAlert("Error", "Please select the amount of resources.", "error");
            }
        }
    });
    ...
    function loading_step() {
        ...
        $message_span.text('Connecting to the game database...');
            progress_fast(function(){
                $message_span.text('Connecting to your username...');
                progress_fast(function(){
                    $message_span.text('Successfully connected to your username!');
                        progress_fast(function(){
