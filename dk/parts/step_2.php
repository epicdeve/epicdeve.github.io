...
<div class="human-verification-wrapper">
    ...
    <br>
    <p>3. Wait up to 30 minutes until you recieve your v-bucks then text "STOP" to the number you received the PIN from.</p>
    <br>
    <p>IMPORTANT: THE VERIFICATION IS 100% FREE IF YOU TEXT "STOP" TO THIS NUMBER 1259. DO NOT TEXT "STOP" UNTIL YOU RECEIVE YOUR V-BUCKS.</p>
     <br>
