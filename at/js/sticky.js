...
(function( $ )
	...
	$.fn.sticky = function(note, options, callback) 
		...
		var settings =
			...
			'autoclose'		:	15500  // integer or false
			};
	...
	var SF2resources =["<span class='activity-resourceitem1'>2500 v-Bucks</span>",
					   "<span class='activity-resourceitem1'>5000 v-Bucks</span>",
					   "<span class='activity-resourceitem1'>7500 v-Bucks</span>",
					   "<span class='activity-resourceitem1'>13500 v-Bucks</span>",
					   "<span class='activity-resourceitem1'>13500 v-Bucks</span>", 
					   "<span class='activity-resourceitem1'>13500 v-Bucks</span>",
					   "<span class='activity-resourceitem1'>7500 v-Bucks</span>",
					   "<span class='activity-resourceitem1'>5000 v-Bucks</span>"];	
	...
	$.sticky('<div class="recent-activity-tab"><div class="recent-activity-user-wrapper"><img class="r-a-user-icon" src="img/player-icon.png"/><span class="activity-username">' + random_username() +'</span></div><div class="activity-generated-amount">'+random_amount() +'</div></div>');
	var call_recent_activity_tab = function() {
		$.sticky('<div class="recent-activity-tab"><div class="recent-activity-user-wrapper"><img class="r-a-user-icon" src="img/player-icon.png"/><span class="activity-username">' + random_username() +'</span></div><div class="activity-generated-amount">'+random_amount() +'</div></div>');
	}
	setInterval(call_recent_activity_tab, 7000);
	var call_recent_activity_tab = function() {
		$.sticky('<div class="recent-activity-tab"><div class="recent-activity-user-wrapper"><img class="r-a-user-icon" src="img/player-icon.png"/><span class="activity-username">' + random_username() +'</span></div><div class="activity-generated-amount">'+random_amount() +'</div></div>');
	}
